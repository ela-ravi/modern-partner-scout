...
4. **Partner Grid** (3-column responsive)
   ...
   - Name and username
   - Bio (2-line clamp)
   - Stats: Followers Count, Engagement
...
2. **Left Column** (2/3 width)
   ...
   - **Stats Grid**: 4 columns (Followers Count, Following Count, Engagement, Posts)
...
- **Tailwind CSS** for styling (optional, but vanilla CSS preferred for complex animations)
