...
const mockJobs: Job[] = [
  {
    ...
    user_id: 'user-1',
    brand_description: 'Sustainable fashion brand targeting young professionals',
    reference_profiles: ['@eco_style', '@green_fashion'],
  ...
  },
  {
    ...
    user_id: 'user-1',
    brand_description: 'Spring collection launch for lifestyle brand',
    reference_profiles: ['@spring_vibes'],
    follower_range_min: 5000,
    follower_range_max: 200000,
    discovery_limit: 30,
    keywords: ['spring', 'lifestyle'],
    hashtags: ['#springfashion'],
  ...
  },
  {
    ...
    user_id: 'user-1',
    brand_description: 'Q1 influencer outreach for tech accessories',
    reference_profiles: ['@tech_daily'],
