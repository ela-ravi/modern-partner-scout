      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/50 text-sm max-w-xs mb-6">
              AI-powered Instagram partner discovery for D2C brands.
              Find, score, and connect with the perfect collaborators.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/50 hover:text-brand-accent hover:bg-white/10 transition-colors"
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} PartnerScout AI. All rights reserved.
          </p>
