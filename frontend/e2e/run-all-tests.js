...
const TEST_SUITES = [
  { name: 'Authentication', file: 'auth.spec.js', critical: true },
  { name: 'Sessions', file: 'sessions.spec.js', critical: true },
  { name: 'Discovery Config', file: 'discovery-config.spec.js', critical: true },
  { name: 'Dashboard', file: 'dashboard.spec.js', critical: true },
  { name: 'Pipeline', file: 'pipeline.spec.js', critical: false },
  { name: 'Profile Detail', file: 'profile-detail.spec.js', critical: false },
  { name: 'Email Composer', file: 'email-composer.spec.js', critical: false },
  { name: 'Epic 5 Dashboard Journey', file: 'epic5-dashboard-journey.spec.js', critical: false },
];
